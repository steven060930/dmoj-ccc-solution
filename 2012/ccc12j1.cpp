...
int main() {
	...
	cin.tie(nullptr);
	int n, m; 	read(n, m);
	if (m <= n) {print("Congratulations, you are within the speed limit!"); return 0; }
	else if (m-n >= 1 && m-n <= 20) print("You are speeding and your fine is $100.");
	else if (m-n >= 21 && m-n <= 30) print("You are speeding and your fine is $270.");
